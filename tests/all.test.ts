...
import { HaversineGeoProvider } from '../src/providers/geo/haversine.geo.provider';
import { MockKycProvider } from '../src/providers/kyc/mock.kyc.provider';
import { MockPaymentProvider } from '../src/providers/payment/mock.payment.provider';
import { generateTokens, verifyAccessToken, TokenPayload } from '../src/lib/jwt';
...
describe('4. Multi-Tenant JWT Token & Claim Verification Tests', () => {
  test('Signs and verifies JWT claims with companyId tenant isolation', () => {
    ...
    assert.equal(verified.role, Role.COMPANY_OWNER);
